        ...
        <div className="login-forms">
          ...
          <form action="">
            ...
            >
              ...
              <input className="input-login" type="username" placeholder="Enter Username or Email" ref={username} />
            </div>
            <div
              className="form-groups"
              style={{
            ...
            >
              ...
              <input className="input-login" type={showPassword ? "text" : "password"} placeholder="Enter Password" name="password" ref={password} />
              ...
              <div className="form-groups">
                <label className="checkbox-container checkbox-label">
                  <input type="checkbox" className="checkbox-input" checked={rememberMe} onChange={() => setRememberMe(!rememberMe)} />
                  <h4>Remember Me</h4>
                </label>
              </div>
              ...
              <button onClick={handleLogin} className="login" style={{ marginTop: "20px" }} disabled={isFetching}>
                {isFetching ? <></> : "Log In"}
              </button>
            </div>
            ...
            <Link to="/google" style={{ textDecoration: "none" }}>
              <button type="button" className="login-else" style={{ marginTop: "20px" }}>
            ...
            <button type="button" className="login-else" style={{ marginTop: "20px" }} onClick={handleFacebook}>
              <span className="login-else-icon">
                <Icon icon="brandico:facebook-rect" width={20} height={20} color="rgb(43, 88, 209)" />
              </span>
            ...
            >
              ...
              <Link to="/signup" className="button-signup" style={{ width: "60px" }}>
                Sign Up
              </Link>
            </div>
          </form>
